                    ...
                    if (postIndex >= index * (postsPerPage / postContainers.length) &&
                        ...
                        container.innerHTML += `<div class="col-4">
                                                        ...
                                                        <div class="card card1" >
                                                            <img src="${imgUrl}"  class="object-fit-cover img">
                                                                <div class="card-body dontmove" id="${postid}">
                                                                    <div class="row">
                                                                        <div class="col-4 col-lg-8 mt-2 d-flex ">
                                                                            <div class="circle-box others" id=" ${uid}" style="background: url('${userImage}') center center / cover no-repeat;"></div>
                                                                            <div class="ms-2">
                                                                                <strong>${username}</strong>
                                                                                <p class="fs-lg-6  fs-8 text-nowrap" style="opacity: 0.4;">${height}cm ${weight}kg</p>
                                                                            </div>
                                                                        </div>
                    ...
                    collectposts.forEach(function(l,index){                          
                        if(icon.children.length === 0){     
                            if(collectposts[index] ==poid){
                                icon.innerHTML +=`<p class="bi display-7 mt-2 collect bi-bookmark-fill icollect"></p>` 
                            }
                        }   
                    })
                    if(icon.children.length === 0){
                        if(collectposts[index] !=poid){
                            icon.innerHTML +=`<p class="bi bi-bookmark display-7 mt-2 collect" ></p>`
                        }
                    }    
                    ...
                    liketposts.forEach(function(l,index){                          
                        if(icon2.children.length === 0){     
                            if(liketposts[index] ==poid){
                                    icon2.innerHTML +=`<p class="bi display-7 mt-2 me-3 love bi-heart-fill ilove" style="position: relative; top: 2px;"></p>`
                            }
                        }   
                    })
                    if(icon2.children.length === 0){
                        if(liketposts[index] !=poid){
                        icon2.innerHTML +=`<p class="bi bi-heart display-7 mt-2 me-3 love" style="position: relative; top: 2px;" ></p>`
                        }
                    }
